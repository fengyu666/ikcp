oooo    oooo   .oooooo.   ooooooooo.   
`888   .8P'   d8P'  `Y8b  `888   `Y88. 
 888  d8'    888           888   .d88' 
 88888[      888           888ooo88P'  
 888`88b.    888           888         
 888  `88b.  `88b    ooo   888         
o888o  o888o  `Y8bood8P'  o888o        
...
比如用户实现了一个P2P穿透，或者某个基于 UDP的协议，而缺乏一套完善的 ARQ可靠
协议实现，那么简单的拷贝这两个文件到现有项目中，稍微编写两行代码，即可使用。
